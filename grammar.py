...
cfg = {
    ...
    "<global>": ["floral <constant> <all-types> #identifier <insert-variable>; <global>"],
    "<constant>": ["hard"],
    "<statement>": [
    ...
    "<string-assignment>": ["=", "+="],
    "<flora-tint-value>": ["<insert-flora-tint> <operate-flora-tint>"],
    "<insert-flora-tint>": [
        "tint literal",
        "flora literal",
    ...
    "<operate-flora-tint>": ["<operator> <insert-operation>"],
    "<insert-operation>": [
        "<insert-flora-tint> <operate-flora-tint>",
        "(<insert-flora-tint> <operate-flora-tint>) <operate-flora-tint>"
    ],
    "<operator>": ["+", "-", "*", "/", "%", "**", "//"],
    "<more-flora-tint>": [", <flora-tint-value> <more-flora-tint>"],
    "<string-value>": [
        "chard literal",
        "string literal",
        "bloom literal",
    ...
    "<concatenate>": ["+ <string-value> <concatenate>"],
    "<add-florist>": ["<indexing> + <all-type-value> <add-florist>"],
    "<indexing>": ["[<insert-index>] <indexing>"],
    ...
    "<2D-start-end-step>": ["[<2D-insert-start>"],
    ...
    "<3D-start-end-step>": ["[<3D-insert-start>"],
    ...
    "<next-2D-sqnc>": [", <2D-sqnc>"],
    "<next-3D-sqnc>": [", <common-data> <next-3D-sqnc>"],
    "<open-bracket>": ["[", "{"],
    "<dirt>": ["string literal :"],
    "<close-bracket>": ["]", "}"],
    "<insert-func>": ["(<argument>) <instance-grab>"],
    "<instance-grab>": ["#identifier().identifier"],
    "<i/o-statement>": ["mint(<all-type-value>)", "<insert-inpetal> inpetal(string literal)"],
    "<insert-inpetal>": ["<all-types>", "#identifier <insert-func>"],
    "<more-id>": ["<indexing> , #identifier <insert-func> <indexing> <more-id>"],
    "<more-all>": [", <all-type-value> <more-all>"],
    "<insert-assignment>": ["<all-assignment> <all-type-value> <more-all>"],
    "<insert-condition>": [
    ...
    "<more-type>": [", <common-type <more-type>"],
    "<string-operand>": ["<all-type-value> <more-all>", "<all-types> <more-all-types>"],
    "<more-all-types>": [", <all-types> <more-all-types>"],
    ...
    "<keyword-param>": ["<common-type> *#identifier", "**#identifier"],
    "<more-key-param>": [", <keyword-param> <more-key-param>"],
    "<next-parameter>": [", <insert-parameter>"],
    "<2D-parameter>": [
        "<keyword-param> <more-key-param>",
    ...
    "<next-2D-param>": [", <2D-parameter>"],
    "<next-3D-param>": [", <all-types> #identifier <insert-variable> <next-3D-param>"]
}
...
first_set = {
    ...
    "<global>": ["floral"],
    "<constant>": ["hard"],
    "<statement>": ["hard", "tint", "flora", "chard", "string", "bloom", "florist", "tulip", "dirt", "stem", "#", "inpetal", "mint", "leaf", "fern", "willow", "tree", "clear", "break"],
    ...
    "<all-assignment>": ["=", "+", "-", "*", "/", "%"],
    "<string-assignment>": ["=", "+"],
    "<flora-tint-value>": ["tint literal", "flora literal", "#", "lent"],
    ...
    "<insert-parameter>": ["tint", "flora", "chard", "string", "bloom", "*", ",", "florist", "tulip", "dirt", "stem", "[", "{"],
    "<keyword-param>": ["tint", "flora", "chard", "string", "bloom", "*#", "**#"],
    "<more-key-param>": [","],
    "<next-parameter>": [","],
    "<2D-parameter>": ["tint", "flora", "chard", "string", "bloom", "*", ",", "florist", "tulip", "dirt", "stem", "[", "{"],
    "<next-2D-param>": [","],
    "<next-3D-param>": [","]
}
